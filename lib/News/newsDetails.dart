...
class NewsDetail extends StatefulWidget {
  ...
  NewsDetail(this.event);
  @override
  NewsDetailState createState() {
    return new  NewsDetailState(this.event);
  }
}
          ...
          child: new Container(
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Text(event['Description'],style: new TextStyle(color: Colors.black, fontFamily: 'Arvo', fontSize: 19.0,)),
